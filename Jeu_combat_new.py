...
class Boss:
    def __init__(self,pv,y,speed,speedanim,cd1,cd2,cd3,element,fond,nom_fond):
...
class Hero:
    def __init__(self,pv,y,speed,spanim1,marche,cd1,cd2,element):
        self.image = None
        self.pv = pv
        self.pv_base = pv
        self.pos_x = 50
...
class JeuCombat:
    ...
    def lancer(self):
        ...
        while not self.j1.hero.get_victoire() and not self.j2.boss.get_victoire() and self.run:
            ...
            #assert 0 <= self.j1.hero.get_pos_x() <= 1000, "Position héros hors de la fenêtre"
            ...
            '''if isinstance(self.j2, Pandora) and self.j2.minion:
